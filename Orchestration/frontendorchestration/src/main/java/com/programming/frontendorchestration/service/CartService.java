...
public class CartService {
	...
	public ResponseEntity<?> deleteItem(String token, int categoryId, int productId) {
	    ...
	    try {
	        restTemplate.delete(url + "?userId=" + cartRes.getUserId()+"&categoryId=" + categoryId + "&productId=" + productId);
